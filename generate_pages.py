    ...
    <header class="site-header">
        <div class="nav-container">
            ...
            <div class="nav-actions">
                <a href="{pages_p}dash-portal.html" class="btn-header-aduan">
                    <i class="fas fa-key"></i> DaSH Portal
                </a>
        ...
        <div class="footer-top">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="{pages_p}dash-portal.html"><i class="fas fa-key"></i> DaSH Portal (Reset Password Pelajar)</a></li>
                </ul>
            </div>
            <div class="footer-col">
    ...
    <section class="hero-banner">
        <div class="hero-container">
            ...
            <div class="hero-actions">
                <a href="pages/dash-portal.html" class="btn-hero btn-hero-yellow">
                    <i class="fas fa-key"></i> DaSH Portal
                </a>
            ...
            <!-- DaSH Portal Explanatory Card -->
            <div style="background: rgba(255, 255, 255, 0.12); backdrop-filter: blur(8px); border: 1px solid rgba(251, 192, 45, 0.6); border-radius: 12px; padding: 14px 20px; margin: 20px auto 0; max-width: 860px; display: flex; align-items: center; justify-content: space-between; gap: 14px; flex-wrap: wrap; text-align: left; box-shadow: 0 4px 20px rgba(0,0,0,0.15);">
                <div style="display: flex; align-items: center; gap: 14px;">
                    <div style="width: 44px; height: 44px; border-radius: 50%; background: #fbc02d; color: #0d1442; display: flex; align-items: center; justify-content: center; font-size: 20px; flex-shrink: 0;">
                ...
                <div style="display: flex; gap: 8px;">
                    <a href="pages/dash-portal.html" class="btn-card btn-card-primary" style="background: #ffffff; color: #1a237e; font-weight: 700; border: none; padding: 8px 16px; font-size: 12px; white-space: nowrap;">
                        <i class="fas fa-book-open"></i> Panduan Murid
                    </a>
                    <a href="{DASH_PORTAL_URL}" target="_blank" class="btn-hero btn-hero-yellow" style="padding: 8px 16px; font-size: 12px; white-space: nowrap;">
