...
<main class="main-wrapper">
    ...
    <div class="content-box">
        ...
        <div style="display: flex; flex-direction: column; align-items: center; gap: 16px; margin: 20px 0;">
            <!-- Pengerusi -->
            <div style="background: linear-gradient(135deg, #1a237e, #1565c0); color: white; padding: 14px 28px; border-radius: 8px; text-align: center; box-shadow: var(--shadow-md); min-width: 260px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 16px; width: 100%;">
                <div style="background: #e8eaf6; border: 1px solid #c5cae9; padding: 14px; border-radius: 8px; text-align: center;">
