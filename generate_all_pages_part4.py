...
<main class="main-wrapper">
    ...
    <div class="page-header-box">
        ...
        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
            <a href="../assets/docs/Manual_Pelajar_DaSH_Portal_SMJK_AMC.pdf" target="_blank" download class="btn-card btn-card-primary" style="background: #ffffff; color: #1a237e; border: 1px solid #1a237e; font-weight: 700; display: inline-flex; align-items: center; gap: 8px;">
                <i class="fas fa-file-pdf" style="color: #d93025; font-size: 16px;"></i> Muat Turun Manual PDF
            </a>
